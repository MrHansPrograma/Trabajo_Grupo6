 ...
 * @author user
 */
public class INST_VistaDetalladaUI extends javax.swing.JFrame {

    int xMouse;
    int yMouse;
    Nodo_LDE<InstitutionData> ptr = InstitutionManager_LDE.personas().head();
    
    public INST_VistaDetalladaUI() {
        initComponents();
        MostrarDatos(ptr);   
    }
    ...
    private void initComponents() {
        ...
        jLabel_RUC1 = new javax.swing.JLabel();
        ...
        jPanel1.add(jLabel_Fecha_Final, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 170, 20));
        ...
        jLabel_RUC.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_RUC.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_RUC, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 160, 100, -1));
        ...
        jPanel1.add(jLabel_Email, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 160, 170, -1));
        ...
        jPanel1.add(jLabel_ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 150, -1));
        ...
        jPanel1.add(jLabel_Fecha_Inicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 180, 10));
        ...
        jPanel1.add(jLabel_Email1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));
        ...
        jLabel_RUC1.setFont(new java.awt.Font("Nirmala UI", 1, 14)); // NOI18N
        jLabel_RUC1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel_RUC1.setText("RUC:");
        jPanel1.add(jLabel_RUC1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 160, -1, -1));
    ...
    private void MostrarDatos(Nodo_LDE<InstitutionData> ptr){
        ...
        jLabel_RUC.setText(String.valueOf(ptr.value().getRUC()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(INST_VistaDetalladaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new INST_VistaDetalladaUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabel_RUC1;
