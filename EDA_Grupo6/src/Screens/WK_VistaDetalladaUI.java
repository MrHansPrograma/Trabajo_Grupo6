...
public class WK_VistaDetalladaUI extends javax.swing.JFrame {

    int xMouse;
    int yMouse;
    Nodo_LDE<EmployeeData> ptr = EmployeeManager_LDE.personas().head();
    
    public WK_VistaDetalladaUI() {
        initComponents();
        MostrarDatos(ptr);
    }
    ...
    private void initComponents() {
        ...
        jLabel_ID_WK = new javax.swing.JLabel();
        ...
        jLabel_ID_WK1 = new javax.swing.JLabel();
        ...
        jPanel1.add(jLabel_Apellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 160, 140, -1));
        ...
        jPanel1.add(jLabel_Fecha_Final, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 150, 20));

        jLabel_Nombre.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_Nombre.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 130, -1));

        jLabel_ID_WK.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_ID_WK.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_ID_WK, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 160, 80, -1));
        ...
        jPanel1.add(jLabel_Telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 140, -1));
        ...
        jPanel1.add(jLabel_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 50, 350, -1));

        jLabel_Email.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_Email.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_Email, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 210, 170, -1));
        ...
        jPanel1.add(jLabel_Prioridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 80, -1));

        jLabel_ID.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_ID.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, 150, -1));

        jLabel_Estado.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_Estado.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, 160, -1));

        jLabel_Asunto.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        jLabel_Asunto.setForeground(new java.awt.Color(102, 102, 102));
        jPanel1.add(jLabel_Asunto, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 310, 400, -1));
        ...
        jPanel1.add(jLabel_Fecha_Inicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, 120, -1));
        ...
        jPanel1.add(jButton_Retroceder, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, -1, -1));

        jButton_Avanzar.setText(">>>");
        jButton_Avanzar.setActionCommand("");
        jButton_Avanzar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButton_AvanzarMouseClicked(evt);
            }
        });
        jPanel1.add(jButton_Avanzar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 50, -1, -1));
        ...
        jPanel1.add(jLabel_ID1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));
        ...
        jPanel1.add(jLabel_Nombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, -1, -1));
        ...
        jPanel1.add(jLabel_Telefono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, -1, -1));
        ...
        jPanel1.add(jLabel_Fecha_Inicio1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, -1, -1));
        ...
        jPanel1.add(jLabel_Asunto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, -1, -1));
        ...
        jPanel1.add(jLabel_Fecha_Final1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, -1, -1));
        ...
        jPanel1.add(jLabel_Email1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, -1));
        ...
        jPanel1.add(jLabel_Apellidos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));
        ...
        jPanel1.add(jLabel_Estado1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, -1, -1));
        ...
        jPanel1.add(jLabel_Prioridad1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, -1, -1));

        jLabel_ID_WK1.setFont(new java.awt.Font("Nirmala UI", 1, 14)); // NOI18N
        jLabel_ID_WK1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel_ID_WK1.setText("ID Empl.:");
        jPanel1.add(jLabel_ID_WK1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 160, -1, -1));
    ...
    private void MostrarDatos(Nodo_LDE<EmployeeData> ptr){
        jLabel_Apellidos.setText(ptr.value().getApellidos());
        ...
        jLabel_ID_WK.setText(String.valueOf(ptr.value().getID_employee()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WK_VistaDetalladaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WK_VistaDetalladaUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabel_ID_WK;
    private javax.swing.JLabel jLabel_ID_WK1;
